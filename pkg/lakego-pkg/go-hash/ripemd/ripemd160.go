...
func (d *ripemd160digest) Size() int {
    return Size160
}

func (d *ripemd160digest) BlockSize() int {
    return BlockSize160
}
...
func (d *ripemd160digest) checkSum() [Size160]byte {
...
func block160(md *ripemd160digest, p []byte) int {
    n := 0
    var x [16]uint32
