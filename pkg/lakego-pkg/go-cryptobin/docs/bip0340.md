...
~~~go
import (
    "github.com/deatil/go-cryptobin/cryptobin/bip0340"
)
~~~
...
func main() {
    ...
    // 生成证书
    // 可选参数 [P521 | P384 | P256 | P224 | S256]
    ec := bip0340.GenerateKey("P521")
...
func main() {
    ...
    var base64signedString string = bip0340.
        FromString(data).
