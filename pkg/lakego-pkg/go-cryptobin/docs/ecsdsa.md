...
~~~go
import (
    "github.com/deatil/go-cryptobin/cryptobin/ecsdsa"
)
~~~
...
与 WithEncodingASN1() 和 WithEncodingBytes() 配合使用
...
func main() {
    ...
    var base64signedString string = ecsdsa.
        FromString(data).
