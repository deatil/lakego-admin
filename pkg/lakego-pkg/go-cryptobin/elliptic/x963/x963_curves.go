...
var (
    ansit163k1 base_elliptic.Curve
    ansit163r1 base_elliptic.Curve
    ansit163r2 base_elliptic.Curve
    ansit193r1 base_elliptic.Curve
    ansit193r2 base_elliptic.Curve
    ansit233k1 base_elliptic.Curve
    ansit233r1 base_elliptic.Curve
    ansit239k1 base_elliptic.Curve
    ansit283k1 base_elliptic.Curve
    ansit283r1 base_elliptic.Curve
    ansit409k1 base_elliptic.Curve
    ansit409r1 base_elliptic.Curve
    ansit571k1 base_elliptic.Curve
    ansit571r1 base_elliptic.Curve
)

func initAll() {
    ansit163k1 = base_elliptic.NewCurve(
    ...
    ansit163r1 = base_elliptic.NewCurve(
        &base_elliptic.CurveParams{
            Name:    "ansit163r1",
            BitSize: 163,
            F:       base_elliptic.F(163, 7, 6, 3, 0),
    ...
    ansit163r2 = base_elliptic.NewCurve(
        &base_elliptic.CurveParams{
            Name:    "ansit163r2",
            BitSize: 163,
            F:       base_elliptic.F(163, 7, 6, 3, 0),
    ...
    ansit193r1 = base_elliptic.NewCurve(
        &base_elliptic.CurveParams{
            Name:    "ansit193r1",
            BitSize: 193,
    ...
    ansit193r2 = base_elliptic.NewCurve(
        &base_elliptic.CurveParams{
            Name:    "ansit193r2",
            BitSize: 193,
            F:       base_elliptic.F(193, 15, 0),
    ...
    ansit233k1 = base_elliptic.NewCurve(
        &base_elliptic.CurveParams{
            Name:    "ansit233k1",
            BitSize: 233,
    ...
    ansit233r1 = base_elliptic.NewCurve(
        &base_elliptic.CurveParams{
            Name:    "ansit233r1",
            BitSize: 233,
            F:       base_elliptic.F(233, 74, 0),
    ...
    ansit239k1 = base_elliptic.NewCurve(
        &base_elliptic.CurveParams{
            Name:    "ansit239k1",
            BitSize: 239,
    ...
    ansit283k1 = base_elliptic.NewCurve(
        &base_elliptic.CurveParams{
            Name:    "ansit283k1",
            BitSize: 283,
    ...
    ansit283r1 = base_elliptic.NewCurve(
        &base_elliptic.CurveParams{
            Name:    "ansit283r1",
            BitSize: 283,
            F:       base_elliptic.F(283, 12, 7, 5, 0),
    ...
    ansit409k1 = base_elliptic.NewCurve(
        &base_elliptic.CurveParams{
            Name:    "ansit409k1",
            BitSize: 409,
    ...
    ansit409r1 = base_elliptic.NewCurve(
        &base_elliptic.CurveParams{
            Name:    "ansit409r1",
            BitSize: 409,
            F:       base_elliptic.F(409, 87, 0),
    ...
    ansit571k1 = base_elliptic.NewCurve(
        &base_elliptic.CurveParams{
            Name:    "ansit571k1",
            BitSize: 571,
    ...
    ansit571r1 = base_elliptic.NewCurve(
        &base_elliptic.CurveParams{
            Name:    "ansit571r1",
            BitSize: 571,
            F:       base_elliptic.F(571, 10, 5, 2, 0),
