...
//
// m = 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffec3 (from "2^384 - 317")
//
//
//
...
func p384Mul(out1 *p384MontgomeryDomainFieldElement, arg1 *p384MontgomeryDomainFieldElement, arg2 *p384MontgomeryDomainFieldElement) {
    ...
    var x30 uint64
    _, x30 = bits.Mul64(x17, 0xec9e48ae6f71de15)
    var x32 uint64
    var x33 uint64
    ...
    var x38 uint64
    var x39 uint64
    x39, x38 = bits.Mul64(x30, 0xffffffffffffffff)
    var x40 uint64
    var x41 uint64
    x41, x40 = bits.Mul64(x30, 0xffffffffffffffff)
    var x42 uint64
    var x43 uint64
    x43, x42 = bits.Mul64(x30, 0xfffffffffffffec3)
    var x44 uint64
    var x45 uint64
    ...
    var x106 uint64
    _, x106 = bits.Mul64(x92, 0xec9e48ae6f71de15)
    var x108 uint64
    var x109 uint64
    ...
    var x114 uint64
    var x115 uint64
    x115, x114 = bits.Mul64(x106, 0xffffffffffffffff)
    var x116 uint64
    var x117 uint64
    x117, x116 = bits.Mul64(x106, 0xffffffffffffffff)
    var x118 uint64
    var x119 uint64
    x119, x118 = bits.Mul64(x106, 0xfffffffffffffec3)
    var x120 uint64
    var x121 uint64
    ...
    var x183 uint64
    _, x183 = bits.Mul64(x169, 0xec9e48ae6f71de15)
    var x185 uint64
    var x186 uint64
    ...
    var x191 uint64
    var x192 uint64
    x192, x191 = bits.Mul64(x183, 0xffffffffffffffff)
    var x193 uint64
    var x194 uint64
    x194, x193 = bits.Mul64(x183, 0xffffffffffffffff)
    var x195 uint64
    var x196 uint64
    x196, x195 = bits.Mul64(x183, 0xfffffffffffffec3)
    var x197 uint64
    var x198 uint64
    ...
    var x260 uint64
    _, x260 = bits.Mul64(x246, 0xec9e48ae6f71de15)
    var x262 uint64
    var x263 uint64
    ...
    var x268 uint64
    var x269 uint64
    x269, x268 = bits.Mul64(x260, 0xffffffffffffffff)
    var x270 uint64
    var x271 uint64
    x271, x270 = bits.Mul64(x260, 0xffffffffffffffff)
    var x272 uint64
    var x273 uint64
    x273, x272 = bits.Mul64(x260, 0xfffffffffffffec3)
    var x274 uint64
    var x275 uint64
    ...
    var x337 uint64
    _, x337 = bits.Mul64(x323, 0xec9e48ae6f71de15)
    var x339 uint64
    var x340 uint64
    ...
    var x345 uint64
    var x346 uint64
    x346, x345 = bits.Mul64(x337, 0xffffffffffffffff)
    var x347 uint64
    var x348 uint64
    x348, x347 = bits.Mul64(x337, 0xffffffffffffffff)
    var x349 uint64
    var x350 uint64
    x350, x349 = bits.Mul64(x337, 0xfffffffffffffec3)
    var x351 uint64
    var x352 uint64
    ...
    var x414 uint64
    _, x414 = bits.Mul64(x400, 0xec9e48ae6f71de15)
    var x416 uint64
    var x417 uint64
    ...
    var x422 uint64
    var x423 uint64
    x423, x422 = bits.Mul64(x414, 0xffffffffffffffff)
    var x424 uint64
    var x425 uint64
    x425, x424 = bits.Mul64(x414, 0xffffffffffffffff)
    var x426 uint64
    var x427 uint64
    x427, x426 = bits.Mul64(x414, 0xfffffffffffffec3)
    var x428 uint64
    var x429 uint64
    ...
    var x454 uint64
    var x455 uint64
    x454, x455 = bits.Sub64(x441, 0xfffffffffffffec3, uint64(0x0))
    var x456 uint64
    var x457 uint64
    x456, x457 = bits.Sub64(x443, 0xffffffffffffffff, uint64(p384Uint1(x455)))
    var x458 uint64
    var x459 uint64
    x458, x459 = bits.Sub64(x445, 0xffffffffffffffff, uint64(p384Uint1(x457)))
    var x460 uint64
    var x461 uint64
...
func p384Add(out1 *p384MontgomeryDomainFieldElement, arg1 *p384MontgomeryDomainFieldElement, arg2 *p384MontgomeryDomainFieldElement) {
    ...
    var x13 uint64
    var x14 uint64
    x13, x14 = bits.Sub64(x1, 0xfffffffffffffec3, uint64(0x0))
    var x15 uint64
    var x16 uint64
    x15, x16 = bits.Sub64(x3, 0xffffffffffffffff, uint64(p384Uint1(x14)))
    var x17 uint64
    var x18 uint64
    x17, x18 = bits.Sub64(x5, 0xffffffffffffffff, uint64(p384Uint1(x16)))
    var x19 uint64
    var x20 uint64
...
func p384Sub(out1 *p384MontgomeryDomainFieldElement, arg1 *p384MontgomeryDomainFieldElement, arg2 *p384MontgomeryDomainFieldElement) {
    ...
    var x14 uint64
    var x15 uint64
    x14, x15 = bits.Add64(x1, (x13 & 0xfffffffffffffec3), uint64(0x0))
    var x16 uint64
    var x17 uint64
    x16, x17 = bits.Add64(x3, x13, uint64(p384Uint1(x15)))
    var x18 uint64
    var x19 uint64
    x18, x19 = bits.Add64(x5, x13, uint64(p384Uint1(x17)))
    var x20 uint64
    var x21 uint64
...
func p384FromMontgomery(out1 *p384NonMontgomeryDomainFieldElement, arg1 *p384MontgomeryDomainFieldElement) {
    x1 := arg1[0]
    var x2 uint64
    _, x2 = bits.Mul64(x1, 0xec9e48ae6f71de15)
    var x4 uint64
    var x5 uint64
    ...
    var x14 uint64
    var x15 uint64
    x15, x14 = bits.Mul64(x2, 0xfffffffffffffec3)
    var x16 uint64
    var x17 uint64
    ...
    var x52 uint64
    _, x52 = bits.Mul64(x40, 0xec9e48ae6f71de15)
    var x54 uint64
    var x55 uint64
    ...
    var x62 uint64
    var x63 uint64
    x63, x62 = bits.Mul64(x52, 0xffffffffffffffff)
    var x64 uint64
    var x65 uint64
    x65, x64 = bits.Mul64(x52, 0xfffffffffffffec3)
    var x66 uint64
    var x67 uint64
    ...
    var x102 uint64
    _, x102 = bits.Mul64(x90, 0xec9e48ae6f71de15)
    var x104 uint64
    var x105 uint64
    ...
    var x110 uint64
    var x111 uint64
    x111, x110 = bits.Mul64(x102, 0xffffffffffffffff)
    var x112 uint64
    var x113 uint64
    x113, x112 = bits.Mul64(x102, 0xffffffffffffffff)
    var x114 uint64
    var x115 uint64
    x115, x114 = bits.Mul64(x102, 0xfffffffffffffec3)
    var x116 uint64
    var x117 uint64
    ...
    var x152 uint64
    _, x152 = bits.Mul64(x140, 0xec9e48ae6f71de15)
    var x154 uint64
    var x155 uint64
    ...
    var x160 uint64
    var x161 uint64
    x161, x160 = bits.Mul64(x152, 0xffffffffffffffff)
    var x162 uint64
    var x163 uint64
    x163, x162 = bits.Mul64(x152, 0xffffffffffffffff)
    var x164 uint64
    var x165 uint64
    x165, x164 = bits.Mul64(x152, 0xfffffffffffffec3)
    var x166 uint64
    var x167 uint64
    ...
    var x202 uint64
    _, x202 = bits.Mul64(x190, 0xec9e48ae6f71de15)
    var x204 uint64
    var x205 uint64
    ...
    var x210 uint64
    var x211 uint64
    x211, x210 = bits.Mul64(x202, 0xffffffffffffffff)
    var x212 uint64
    var x213 uint64
    x213, x212 = bits.Mul64(x202, 0xffffffffffffffff)
    var x214 uint64
    var x215 uint64
    x215, x214 = bits.Mul64(x202, 0xfffffffffffffec3)
    var x216 uint64
    var x217 uint64
    ...
    var x252 uint64
    _, x252 = bits.Mul64(x240, 0xec9e48ae6f71de15)
    var x254 uint64
    var x255 uint64
    ...
    var x260 uint64
    var x261 uint64
    x261, x260 = bits.Mul64(x252, 0xffffffffffffffff)
    var x262 uint64
    var x263 uint64
    x263, x262 = bits.Mul64(x252, 0xffffffffffffffff)
    var x264 uint64
    var x265 uint64
    x265, x264 = bits.Mul64(x252, 0xfffffffffffffec3)
    var x266 uint64
    var x267 uint64
    ...
    var x290 uint64
    var x291 uint64
    x290, x291 = bits.Sub64(x278, 0xfffffffffffffec3, uint64(0x0))
    var x292 uint64
    var x293 uint64
    x292, x293 = bits.Sub64(x280, 0xffffffffffffffff, uint64(p384Uint1(x291)))
    var x294 uint64
    var x295 uint64
    x294, x295 = bits.Sub64(x282, 0xffffffffffffffff, uint64(p384Uint1(x293)))
    var x296 uint64
    var x297 uint64
...
func p384ToMontgomery(out1 *p384MontgomeryDomainFieldElement, arg1 *p384NonMontgomeryDomainFieldElement) {
    var x1 uint64
    var x2 uint64
    x2, x1 = bits.Mul64(arg1[0], 0x18889)
    var x3 uint64
    _, x3 = bits.Mul64(x1, 0xec9e48ae6f71de15)
    var x5 uint64
    var x6 uint64
    ...
    var x15 uint64
    var x16 uint64
    x16, x15 = bits.Mul64(x3, 0xfffffffffffffec3)
    var x17 uint64
    var x18 uint64
    x17, x18 = bits.Add64(x16, x13, uint64(0x0))
    var x19 uint64
    var x20 uint64
    x19, x20 = bits.Add64(x14, x11, uint64(p384Uint1(x18)))
    var x21 uint64
    var x22 uint64
    x21, x22 = bits.Add64(x12, x9, uint64(p384Uint1(x20)))
    var x23 uint64
    var x24 uint64
    x23, x24 = bits.Add64(x10, x7, uint64(p384Uint1(x22)))
    var x25 uint64
    var x26 uint64
    x25, x26 = bits.Add64(x8, x5, uint64(p384Uint1(x24)))
    var x28 uint64
    _, x28 = bits.Add64(x1, x15, uint64(0x0))
    var x29 uint64
    var x30 uint64
    x29, x30 = bits.Add64(x2, x17, uint64(p384Uint1(x28)))
    var x31 uint64
    var x32 uint64
    x31, x32 = bits.Add64(uint64(0x0), x19, uint64(p384Uint1(x30)))
    var x33 uint64
    var x34 uint64
    x33, x34 = bits.Add64(uint64(0x0), x21, uint64(p384Uint1(x32)))
    var x35 uint64
    var x36 uint64
    x35, x36 = bits.Add64(uint64(0x0), x23, uint64(p384Uint1(x34)))
    var x37 uint64
    var x38 uint64
    x37, x38 = bits.Add64(uint64(0x0), x25, uint64(p384Uint1(x36)))
    var x39 uint64
    var x40 uint64
    x39, x40 = bits.Add64(uint64(0x0), (uint64(p384Uint1(x26)) + x6), uint64(p384Uint1(x38)))
    var x41 uint64
    var x42 uint64
    x42, x41 = bits.Mul64(arg1[1], 0x18889)
    var x43 uint64
    var x44 uint64
    x43, x44 = bits.Add64(x29, x41, uint64(0x0))
    var x45 uint64
    var x46 uint64
    x45, x46 = bits.Add64(x31, x42, uint64(p384Uint1(x44)))
    var x47 uint64
    var x48 uint64
    x47, x48 = bits.Add64(x33, uint64(0x0), uint64(p384Uint1(x46)))
    var x49 uint64
    var x50 uint64
    x49, x50 = bits.Add64(x35, uint64(0x0), uint64(p384Uint1(x48)))
    var x51 uint64
    var x52 uint64
    x51, x52 = bits.Add64(x37, uint64(0x0), uint64(p384Uint1(x50)))
    var x53 uint64
    var x54 uint64
    x53, x54 = bits.Add64(x39, uint64(0x0), uint64(p384Uint1(x52)))
    var x55 uint64
    _, x55 = bits.Mul64(x43, 0xec9e48ae6f71de15)
    var x57 uint64
    var x58 uint64
    x58, x57 = bits.Mul64(x55, 0xffffffffffffffff)
    var x59 uint64
    var x60 uint64
    x60, x59 = bits.Mul64(x55, 0xffffffffffffffff)
    var x61 uint64
    var x62 uint64
    x62, x61 = bits.Mul64(x55, 0xffffffffffffffff)
    var x63 uint64
    var x64 uint64
    x64, x63 = bits.Mul64(x55, 0xffffffffffffffff)
    var x65 uint64
    var x66 uint64
    x66, x65 = bits.Mul64(x55, 0xffffffffffffffff)
    var x67 uint64
    var x68 uint64
    x68, x67 = bits.Mul64(x55, 0xfffffffffffffec3)
    var x69 uint64
    var x70 uint64
    ...
    var x75 uint64
    var x76 uint64
    x75, x76 = bits.Add64(x62, x59, uint64(p384Uint1(x74)))
    var x77 uint64
    var x78 uint64
    x77, x78 = bits.Add64(x60, x57, uint64(p384Uint1(x76)))
    var x80 uint64
    _, x80 = bits.Add64(x43, x67, uint64(0x0))
    var x81 uint64
    var x82 uint64
    x81, x82 = bits.Add64(x45, x69, uint64(p384Uint1(x80)))
    var x83 uint64
    var x84 uint64
    x83, x84 = bits.Add64(x47, x71, uint64(p384Uint1(x82)))
    var x85 uint64
    var x86 uint64
    x85, x86 = bits.Add64(x49, x73, uint64(p384Uint1(x84)))
    var x87 uint64
    var x88 uint64
    x87, x88 = bits.Add64(x51, x75, uint64(p384Uint1(x86)))
    var x89 uint64
    var x90 uint64
    x89, x90 = bits.Add64(x53, x77, uint64(p384Uint1(x88)))
    var x91 uint64
    var x92 uint64
    x91, x92 = bits.Add64((uint64(p384Uint1(x54)) + uint64(p384Uint1(x40))), (uint64(p384Uint1(x78)) + x58), uint64(p384Uint1(x90)))
    var x93 uint64
    var x94 uint64
    x94, x93 = bits.Mul64(arg1[2], 0x18889)
    var x95 uint64
    var x96 uint64
    x95, x96 = bits.Add64(x81, x93, uint64(0x0))
    var x97 uint64
    var x98 uint64
    x97, x98 = bits.Add64(x83, x94, uint64(p384Uint1(x96)))
    var x99 uint64
    var x100 uint64
    x99, x100 = bits.Add64(x85, uint64(0x0), uint64(p384Uint1(x98)))
    var x101 uint64
    var x102 uint64
    x101, x102 = bits.Add64(x87, uint64(0x0), uint64(p384Uint1(x100)))
    var x103 uint64
    var x104 uint64
    x103, x104 = bits.Add64(x89, uint64(0x0), uint64(p384Uint1(x102)))
    var x105 uint64
    var x106 uint64
    x105, x106 = bits.Add64(x91, uint64(0x0), uint64(p384Uint1(x104)))
    var x107 uint64
    _, x107 = bits.Mul64(x95, 0xec9e48ae6f71de15)
    var x109 uint64
    var x110 uint64
    x110, x109 = bits.Mul64(x107, 0xffffffffffffffff)
    var x111 uint64
    var x112 uint64
    x112, x111 = bits.Mul64(x107, 0xffffffffffffffff)
    var x113 uint64
    var x114 uint64
    x114, x113 = bits.Mul64(x107, 0xffffffffffffffff)
    var x115 uint64
    var x116 uint64
    x116, x115 = bits.Mul64(x107, 0xffffffffffffffff)
    var x117 uint64
    var x118 uint64
    x118, x117 = bits.Mul64(x107, 0xffffffffffffffff)
    var x119 uint64
    var x120 uint64
    x120, x119 = bits.Mul64(x107, 0xfffffffffffffec3)
    var x121 uint64
    var x122 uint64
    x121, x122 = bits.Add64(x120, x117, uint64(0x0))
    var x123 uint64
    var x124 uint64
    x123, x124 = bits.Add64(x118, x115, uint64(p384Uint1(x122)))
    var x125 uint64
    var x126 uint64
    x125, x126 = bits.Add64(x116, x113, uint64(p384Uint1(x124)))
    var x127 uint64
    var x128 uint64
    x127, x128 = bits.Add64(x114, x111, uint64(p384Uint1(x126)))
    var x129 uint64
    var x130 uint64
    x129, x130 = bits.Add64(x112, x109, uint64(p384Uint1(x128)))
    var x132 uint64
    _, x132 = bits.Add64(x95, x119, uint64(0x0))
    var x133 uint64
    var x134 uint64
    x133, x134 = bits.Add64(x97, x121, uint64(p384Uint1(x132)))
    var x135 uint64
    var x136 uint64
    x135, x136 = bits.Add64(x99, x123, uint64(p384Uint1(x134)))
    var x137 uint64
    var x138 uint64
    x137, x138 = bits.Add64(x101, x125, uint64(p384Uint1(x136)))
    var x139 uint64
    var x140 uint64
    x139, x140 = bits.Add64(x103, x127, uint64(p384Uint1(x138)))
    var x141 uint64
    var x142 uint64
    x141, x142 = bits.Add64(x105, x129, uint64(p384Uint1(x140)))
    var x143 uint64
    var x144 uint64
    x143, x144 = bits.Add64((uint64(p384Uint1(x106)) + uint64(p384Uint1(x92))), (uint64(p384Uint1(x130)) + x110), uint64(p384Uint1(x142)))
    var x145 uint64
    var x146 uint64
    x146, x145 = bits.Mul64(arg1[3], 0x18889)
    var x147 uint64
    var x148 uint64
    x147, x148 = bits.Add64(x133, x145, uint64(0x0))
    var x149 uint64
    var x150 uint64
    x149, x150 = bits.Add64(x135, x146, uint64(p384Uint1(x148)))
    var x151 uint64
    var x152 uint64
    x151, x152 = bits.Add64(x137, uint64(0x0), uint64(p384Uint1(x150)))
    var x153 uint64
    var x154 uint64
    x153, x154 = bits.Add64(x139, uint64(0x0), uint64(p384Uint1(x152)))
    var x155 uint64
    var x156 uint64
    x155, x156 = bits.Add64(x141, uint64(0x0), uint64(p384Uint1(x154)))
    var x157 uint64
    var x158 uint64
    x157, x158 = bits.Add64(x143, uint64(0x0), uint64(p384Uint1(x156)))
    var x159 uint64
    _, x159 = bits.Mul64(x147, 0xec9e48ae6f71de15)
    var x161 uint64
    var x162 uint64
    x162, x161 = bits.Mul64(x159, 0xffffffffffffffff)
    var x163 uint64
    var x164 uint64
    x164, x163 = bits.Mul64(x159, 0xffffffffffffffff)
    var x165 uint64
    var x166 uint64
    x166, x165 = bits.Mul64(x159, 0xffffffffffffffff)
    var x167 uint64
    var x168 uint64
    x168, x167 = bits.Mul64(x159, 0xffffffffffffffff)
    var x169 uint64
    var x170 uint64
    x170, x169 = bits.Mul64(x159, 0xffffffffffffffff)
    var x171 uint64
    var x172 uint64
    x172, x171 = bits.Mul64(x159, 0xfffffffffffffec3)
    var x173 uint64
    var x174 uint64
    x173, x174 = bits.Add64(x172, x169, uint64(0x0))
    var x175 uint64
    var x176 uint64
    x175, x176 = bits.Add64(x170, x167, uint64(p384Uint1(x174)))
    var x177 uint64
    var x178 uint64
    x177, x178 = bits.Add64(x168, x165, uint64(p384Uint1(x176)))
    var x179 uint64
    var x180 uint64
    x179, x180 = bits.Add64(x166, x163, uint64(p384Uint1(x178)))
    var x181 uint64
    var x182 uint64
    x181, x182 = bits.Add64(x164, x161, uint64(p384Uint1(x180)))
    var x184 uint64
    _, x184 = bits.Add64(x147, x171, uint64(0x0))
    var x185 uint64
    var x186 uint64
    ...
    var x191 uint64
    var x192 uint64
    x191, x192 = bits.Add64(x155, x179, uint64(p384Uint1(x190)))
    var x193 uint64
    var x194 uint64
    x193, x194 = bits.Add64(x157, x181, uint64(p384Uint1(x192)))
    var x195 uint64
    var x196 uint64
    x195, x196 = bits.Add64((uint64(p384Uint1(x158)) + uint64(p384Uint1(x144))), (uint64(p384Uint1(x182)) + x162), uint64(p384Uint1(x194)))
    var x197 uint64
    var x198 uint64
    x198, x197 = bits.Mul64(arg1[4], 0x18889)
    var x199 uint64
    var x200 uint64
    x199, x200 = bits.Add64(x185, x197, uint64(0x0))
    var x201 uint64
    var x202 uint64
    x201, x202 = bits.Add64(x187, x198, uint64(p384Uint1(x200)))
    var x203 uint64
    var x204 uint64
    x203, x204 = bits.Add64(x189, uint64(0x0), uint64(p384Uint1(x202)))
    var x205 uint64
    var x206 uint64
    x205, x206 = bits.Add64(x191, uint64(0x0), uint64(p384Uint1(x204)))
    var x207 uint64
    var x208 uint64
    x207, x208 = bits.Add64(x193, uint64(0x0), uint64(p384Uint1(x206)))
    var x209 uint64
    var x210 uint64
    x209, x210 = bits.Add64(x195, uint64(0x0), uint64(p384Uint1(x208)))
    var x211 uint64
    _, x211 = bits.Mul64(x199, 0xec9e48ae6f71de15)
    var x213 uint64
    var x214 uint64
    x214, x213 = bits.Mul64(x211, 0xffffffffffffffff)
    var x215 uint64
    var x216 uint64
    x216, x215 = bits.Mul64(x211, 0xffffffffffffffff)
    var x217 uint64
    var x218 uint64
    x218, x217 = bits.Mul64(x211, 0xffffffffffffffff)
    var x219 uint64
    var x220 uint64
    x220, x219 = bits.Mul64(x211, 0xffffffffffffffff)
    var x221 uint64
    var x222 uint64
    x222, x221 = bits.Mul64(x211, 0xffffffffffffffff)
    var x223 uint64
    var x224 uint64
    x224, x223 = bits.Mul64(x211, 0xfffffffffffffec3)
    var x225 uint64
    var x226 uint64
    x225, x226 = bits.Add64(x224, x221, uint64(0x0))
    var x227 uint64
    var x228 uint64
    x227, x228 = bits.Add64(x222, x219, uint64(p384Uint1(x226)))
    var x229 uint64
    var x230 uint64
    x229, x230 = bits.Add64(x220, x217, uint64(p384Uint1(x228)))
    var x231 uint64
    var x232 uint64
    x231, x232 = bits.Add64(x218, x215, uint64(p384Uint1(x230)))
    var x233 uint64
    var x234 uint64
    x233, x234 = bits.Add64(x216, x213, uint64(p384Uint1(x232)))
    var x236 uint64
    _, x236 = bits.Add64(x199, x223, uint64(0x0))
    var x237 uint64
    var x238 uint64
    x237, x238 = bits.Add64(x201, x225, uint64(p384Uint1(x236)))
    var x239 uint64
    var x240 uint64
    x239, x240 = bits.Add64(x203, x227, uint64(p384Uint1(x238)))
    var x241 uint64
    var x242 uint64
    x241, x242 = bits.Add64(x205, x229, uint64(p384Uint1(x240)))
    var x243 uint64
    var x244 uint64
    x243, x244 = bits.Add64(x207, x231, uint64(p384Uint1(x242)))
    var x245 uint64
    var x246 uint64
    x245, x246 = bits.Add64(x209, x233, uint64(p384Uint1(x244)))
    var x247 uint64
    var x248 uint64
    x247, x248 = bits.Add64((uint64(p384Uint1(x210)) + uint64(p384Uint1(x196))), (uint64(p384Uint1(x234)) + x214), uint64(p384Uint1(x246)))
    var x249 uint64
    var x250 uint64
    x250, x249 = bits.Mul64(arg1[5], 0x18889)
    var x251 uint64
    var x252 uint64
    x251, x252 = bits.Add64(x237, x249, uint64(0x0))
    var x253 uint64
    var x254 uint64
    x253, x254 = bits.Add64(x239, x250, uint64(p384Uint1(x252)))
    var x255 uint64
    var x256 uint64
    x255, x256 = bits.Add64(x241, uint64(0x0), uint64(p384Uint1(x254)))
    var x257 uint64
    var x258 uint64
    x257, x258 = bits.Add64(x243, uint64(0x0), uint64(p384Uint1(x256)))
    var x259 uint64
    var x260 uint64
    x259, x260 = bits.Add64(x245, uint64(0x0), uint64(p384Uint1(x258)))
    var x261 uint64
    var x262 uint64
    x261, x262 = bits.Add64(x247, uint64(0x0), uint64(p384Uint1(x260)))
    var x263 uint64
    _, x263 = bits.Mul64(x251, 0xec9e48ae6f71de15)
    var x265 uint64
    var x266 uint64
    x266, x265 = bits.Mul64(x263, 0xffffffffffffffff)
    var x267 uint64
    var x268 uint64
    x268, x267 = bits.Mul64(x263, 0xffffffffffffffff)
    var x269 uint64
    var x270 uint64
    x270, x269 = bits.Mul64(x263, 0xffffffffffffffff)
    var x271 uint64
    var x272 uint64
    x272, x271 = bits.Mul64(x263, 0xffffffffffffffff)
    var x273 uint64
    var x274 uint64
    x274, x273 = bits.Mul64(x263, 0xffffffffffffffff)
    var x275 uint64
    var x276 uint64
    x276, x275 = bits.Mul64(x263, 0xfffffffffffffec3)
    var x277 uint64
    var x278 uint64
    x277, x278 = bits.Add64(x276, x273, uint64(0x0))
    var x279 uint64
    var x280 uint64
    x279, x280 = bits.Add64(x274, x271, uint64(p384Uint1(x278)))
    var x281 uint64
    var x282 uint64
    x281, x282 = bits.Add64(x272, x269, uint64(p384Uint1(x280)))
    var x283 uint64
    var x284 uint64
    x283, x284 = bits.Add64(x270, x267, uint64(p384Uint1(x282)))
    var x285 uint64
    var x286 uint64
    x285, x286 = bits.Add64(x268, x265, uint64(p384Uint1(x284)))
    var x288 uint64
    _, x288 = bits.Add64(x251, x275, uint64(0x0))
    var x289 uint64
    var x290 uint64
    x289, x290 = bits.Add64(x253, x277, uint64(p384Uint1(x288)))
    var x291 uint64
    var x292 uint64
    x291, x292 = bits.Add64(x255, x279, uint64(p384Uint1(x290)))
    var x293 uint64
    var x294 uint64
    x293, x294 = bits.Add64(x257, x281, uint64(p384Uint1(x292)))
    var x295 uint64
    var x296 uint64
    x295, x296 = bits.Add64(x259, x283, uint64(p384Uint1(x294)))
    var x297 uint64
    var x298 uint64
    x297, x298 = bits.Add64(x261, x285, uint64(p384Uint1(x296)))
    var x299 uint64
    var x300 uint64
    x299, x300 = bits.Add64((uint64(p384Uint1(x262)) + uint64(p384Uint1(x248))), (uint64(p384Uint1(x286)) + x266), uint64(p384Uint1(x298)))
    var x301 uint64
    var x302 uint64
    x301, x302 = bits.Sub64(x289, 0xfffffffffffffec3, uint64(0x0))
    var x303 uint64
    var x304 uint64
    x303, x304 = bits.Sub64(x291, 0xffffffffffffffff, uint64(p384Uint1(x302)))
    var x305 uint64
    var x306 uint64
    x305, x306 = bits.Sub64(x293, 0xffffffffffffffff, uint64(p384Uint1(x304)))
    var x307 uint64
    var x308 uint64
    x307, x308 = bits.Sub64(x295, 0xffffffffffffffff, uint64(p384Uint1(x306)))
    var x309 uint64
    var x310 uint64
    x309, x310 = bits.Sub64(x297, 0xffffffffffffffff, uint64(p384Uint1(x308)))
    var x311 uint64
    var x312 uint64
    x311, x312 = bits.Sub64(x299, 0xffffffffffffffff, uint64(p384Uint1(x310)))
    var x314 uint64
    _, x314 = bits.Sub64(uint64(p384Uint1(x300)), uint64(0x0), uint64(p384Uint1(x312)))
    var x315 uint64
    p384CmovznzU64(&x315, p384Uint1(x314), x301, x289)
    var x316 uint64
    p384CmovznzU64(&x316, p384Uint1(x314), x303, x291)
    var x317 uint64
    p384CmovznzU64(&x317, p384Uint1(x314), x305, x293)
    var x318 uint64
    p384CmovznzU64(&x318, p384Uint1(x314), x307, x295)
    var x319 uint64
    p384CmovznzU64(&x319, p384Uint1(x314), x309, x297)
    var x320 uint64
    p384CmovznzU64(&x320, p384Uint1(x314), x311, x299)
    out1[0] = x315
    out1[1] = x316
    out1[2] = x317
    out1[3] = x318
