...
func TestSignAndVerify(t *testing.T) {
    tests := []struct {
        ...
        {
            name: "blank",
            seed: "6c82a562cb808d10d632be89c8513ebf" +
            ...
            publicKey: "5fd7449b59b461fd2ce787ec616ad46a" +
                ...
                "d1fa1abeafe8256180",
            message: "",
            signature: "533a37f6bbe457251f023c0d88f976ae" +
        ...
        {
            name: "1 octet",
            seed: "c4eab05d357007c632f3dbb48489924d" +
                "552b08fe0c353a0d4a1f00acda2c463a" +
                "fbea67c5e8d2877c5e3bc397a659949e" +
                "f8021e954e0a12274e",
            publicKey: "43ba28f430cdff456ae531545f7ecd0a" +
                "c834a55d9358c0372bfa0c6c6798c086" +
                "6aea01eb00742802b8438ea4cb82169c" +
                "235160627b4c3a9480",
            message: "03",
            signature: "26b8f91727bd62897af15e41eb43c377" +
        ...
        {
            name: "11 octets",
            seed: "cd23d24f714274e744343237b93290f5" +
                "11f6425f98e64459ff203e8985083ffd" +
                "f60500553abc0e05cd02184bdb89c4cc" +
                "d67e187951267eb328",
            publicKey: "dcea9e78f35a1bf3499a831b10b86c90" +
                "aac01cd84b67a0109b55a36e9328b1e3" +
                "65fce161d71ce7131a543ea4cb5f7e9f" +
                "1d8b00696447001400",
            message: "0c3e544074ec63b0265e0c",
            signature: "1f0a8888ce25e8d458a21130879b840a" +
        ...
        {
            name: "12 octets",
            seed: "258cdd4ada32ed9c9ff54e63756ae582" +
                "fb8fab2ac721f2c8e676a72768513d93" +
                "9f63dddb55609133f29adf86ec9929dc" +
                "cb52c1c5fd2ff7e21b",
            publicKey: "3ba16da0c6f2cc1f30187740756f5e79" +
                "8d6bc5fc015d7c63cc9510ee3fd44adc" +
                "24d8e968b6e46e6f94d19b945361726b" +
                "d75e149ef09817f580",
            message: "64a65f3cdedcdd66811e2915",
            signature: "7eeeab7c4e50fb799b418ee5e3197ff6" +
        ...
        {
            name: "64 octets",
            seed: "d65df341ad13e008567688baedda8e9d" +
                "cdc17dc024974ea5b4227b6530e339bf" +
                "f21f99e68ca6968f3cca6dfe0fb9f4fa" +
                "b4fa135d5542ea3f01",
            publicKey: "df9705f58edbab802c7f8363cfe5560a" +
                "b1c6132c20a9f1dd163483a26f8ac53a" +
                "39d6808bf4a1dfbd261b099bb03b3fb5" +
                "0906cb28bd8a081f00",
            message: "bd0f6a3747cd561bdddf4640a332461a" +
                "4a30a12a434cd0bf40d766d9c6d458e5" +
                "512204a30c17d1f50b5079631f64eb31" +
                "12182da3005835461113718d1a5ef944",
            signature: "554bc2480860b49eab8532d2a533b7d5" +
        ...
        {
            name: "256 octets",
            seed: "2ec5fe3c17045abdb136a5e6a913e32a" +
                "b75ae68b53d2fc149b77e504132d3756" +
                "9b7e766ba74a19bd6162343a21c8590a" +
                "a9cebca9014c636df5",
            publicKey: "79756f014dcfe2079f5dd9e718be4171" +
            ...
            signature: "c650ddbb0601c19ca11439e1640dd931" +
        ...
        {
            name: "1023 octets",
            seed: "872d093780f5d3730df7c212664b37b8" +
                "a0f24f56810daa8382cd4fa3f77634ec" +
                "44dc54f1c2ed9bea86fafb7632d8be19" +
                "9ea165f5ad55dd9ce8",
            publicKey: "a81b2e8a70a5ac94ffdbcc9badfc3feb" +
                "0801f258578bb114ad44ece1ec0e799d" +
                "a08effb81c5d685c0c56f64eecaef8cd" +
                "f11cc38737838cf400",
            message: "6ddf802e1aae4986935f7f981ba3f035" +
            ...
            signature: "e301345a41a39a4d72fff8df69c98075" +
    ...
    for _, tc := range tests {
        t.Run(tc.name, func(t *testing.T) {
            ...
            pub := decodeHex(t, tc.publicKey)
            message := decodeHex(t, tc.message)
            signature := decodeHex(t, tc.signature)

            priv := NewKeyFromSeed(seed)

            if !bytes.Equal(priv[57:], pub) {
                t.Errorf("unexpected public key: got %x, want %x", priv[57:], pub)
            }

            sig := Sign(priv, message)
            if !bytes.Equal(sig, signature) {
                t.Errorf("unexpected signature: got %x, want %x", sig, signature)
            }

            if !Verify(PublicKey(pub), message, signature) {
...
func TestVerify(t *testing.T) {
    ...
    t.Run("Scheme ED448", func(t *testing.T) {
        testVerify(t, public, private, &Options{
            Context: "",
            Scheme: ED448,
        })
    })
...
func testVerify(t *testing.T, pub PublicKey, priv PrivateKey, opts *Options) {
    message := []byte("1023 octets")

    sig, err := priv.Sign(rand.Reader, message, opts)
    if err != nil {
        t.Errorf("unexpected signature: %s", err)
    }

    if err = VerifyWithOptions(pub, message, sig, opts); err != nil {
...
func BenchmarkSign(b *testing.B) {
    seed := decodeHex(b, "6c82a562cb808d10d632be89c8513ebf"+
        "6c929f34ddfa8c9f63c9960ef6e348a3"+
        "528c8a3fcc2f044e39a3fc5b94492f8f"+
        "032e7549a20098f95b")
    message := []byte{}
...
func BenchmarkVerify(b *testing.B) {
    pub := decodeHex(b, "5fd7449b59b461fd2ce787ec616ad46a"+
        "1da1342485a70e1f8a0ea75d80e96778"+
        "edf124769b46c7061bd6783df1e50f6c"+
        "d1fa1abeafe8256180")
    message := []byte{}
    signature := decodeHex(b, "533a37f6bbe457251f023c0d88f976ae"+
        "2dfb504a843e34d2074fd823d41a591f"+
        "2b233f034f628281f2fd7a22ddd47d78"+
        "28c59bd0a21bfd3980ff0d2028d4b18a"+
        "9df63e006c5d1c2d345b925d8dc00b41"+
