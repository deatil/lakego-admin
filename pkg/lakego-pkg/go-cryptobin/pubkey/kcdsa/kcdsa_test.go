...
func Test_GenerateKey2(t *testing.T) {
    ...
    assertNoError(err, "GenerateParameters-Error")
...
func test_PrivateKey_Check(t *testing.T, pemStr string) {
    ...
    assertNoError(err, "PrivateKeyCheck")
