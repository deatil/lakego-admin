...
import (
    ...
    "lakego-admin/lakego/permission"
    "lakego-admin/lakego/permission/interfaces"
    gormAdapter "lakego-admin/lakego/permission/adapter/gorm"
)
...
func Register() {
    once.Do(func() {
        // 注册可用驱动
        register.NewManagerWithPrefix("permission").
...
func Permission(name string, once ...bool) *permission.Permission {
    ...
    adapter := register.NewManagerWithPrefix("permission").
