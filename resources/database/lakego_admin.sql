...
CREATE TABLE `pre__action_log` (
  `id` char(36) CHARACTER SET utf8mb4 NOT NULL DEFAULT '' COMMENT '日志id',
...
CREATE TABLE `pre__admin` (
  ...
  `avatar` char(36) CHARACTER SET utf8mb4 DEFAULT NULL,
...
CREATE TABLE `pre__attachment` (
  `id` char(36) CHARACTER SET utf8mb4 NOT NULL DEFAULT '',
  `owner_id` char(36) CHARACTER SET utf8mb4 DEFAULT '0' COMMENT '关联类型id',
...
CREATE TABLE `pre__auth_group` (
  `id` char(36) CHARACTER SET utf8mb4 NOT NULL DEFAULT '',
  `parentid` char(36) CHARACTER SET utf8mb4 NOT NULL DEFAULT '',
...
CREATE TABLE `pre__auth_group_access` (
  `admin_id` char(36) CHARACTER SET utf8mb4 NOT NULL DEFAULT '',
  `group_id` char(36) CHARACTER SET utf8mb4 NOT NULL DEFAULT '',
...
CREATE TABLE `pre__auth_rule` (
  ...
  `parentid` char(36) CHARACTER SET utf8mb4 DEFAULT '0' COMMENT '上级id',
...
INSERT INTO `pre__admin` VALUES ('01cabd82-060d-405f-ba47-4d79fc47efcf','lakego','da3e31be10e21d4cb8d75b64d3e640e2','ANDsW2','lakego','lakego@admin.com','5acfcd19-3a4c-4a28-8386-ae877952fd11','lakego-admin 是基于 gin、JWT 和 RBAC 的 go 后台管理系统',0,1,0,'',1652759635,'127.0.0.1',1652587697,'127.0.0.1',1652545221,'127.0.0.1'),('642eb7b3-91ea-4808-bba6-f5f10938929a','admin','1b65a57aeb44d988a1a5e713979daa76','QdHJdJ','管理员','lakego-admin@admin.com','5acfcd19-3a4c-4a28-8386-ae877952fd11','lakego-admin 是基于 gin、JWT 和 RBAC 的 go 后台管理系统',1,1,0,'',1670856136,'127.0.0.1',1652587697,'127.0.0.1',1652545221,'127.0.0.1');
