...
type Attachment struct {
    ...
    OwnerType       string      `gorm:"column:owner_type;size:50;not null;" json:"type" validate:"required"`
    OwnerID         string      `gorm:"column:owner_id;size:32;" json:"type_id" validate:"required"`
    ...
    Md5             string      `gorm:"column:md5;size:32;" json:"md5" validate:"required"`
